...
function websdkready() {
  ...
  var CLIENT_ID = "F95sNnUwROuWlJgIhkVq4g";
  /**
   ...
   */
  var CLIENT_SECRET = "qeh5SdjFuGzMuPWQvFI74sS66iS2Y3rN";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "https://host-noteswift.netlify.app/zoom/noreply/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "https://host-noteswift.netlify.app/zoom/noreply/meeting.html?" +
